  ...
  study: [
    {
      ...
      icon: <BsLayers className="w-3.5 h-3.5 flex-shrink-0" />,
    },
    {
      label: "Word guess",
      href: "/study/word-guess",
      icon: <BsPuzzle className="w-3.5 h-3.5 flex-shrink-0" />,
    },
  ],
};
  ...
  if (subs) {
    return (
      <div className="flex flex-col">
        <div
          className={`w-full flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium capitalize
    ${
      isActive
